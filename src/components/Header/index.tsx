...
const Header: FC<HeaderProps> = ({ component }) => {
  ...
  return (
    <div className="w-screen py-4 px-4 lg:px-16 bg-transparent flex justify-end fixed top-0 left-0 right-0">
      <div className={`fixed bg-slate-50/50 top-0 bottom-0 right-0 left-0 transition-all duration-500 ${visibleOverlay}`}>
